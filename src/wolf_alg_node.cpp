    ...
    draw_lines_(false)
{
    ...
    //create the manager
    wolf_manager_ = new WolfManager(state_initial_length, odom_sensor_ptr_,
                                    Eigen::Vector3s::Zero(), Eigen::Matrix3s::Identity() * 0.01, 
                                    window_length_, new_frame_elapsed_time_, false);
    ...
    lines_colors_[0].r = 0; lines_colors_[0].g = 0; lines_colors_[0].b = 1; lines_colors_[0].a = 1;
    lines_colors_[1].r = 1; lines_colors_[1].g = 0; lines_colors_[1].b = 1; lines_colors_[1].a = 1;
    lines_colors_[2].r = 1; lines_colors_[2].g = 0; lines_colors_[2].b = 0; lines_colors_[2].a = 1;
    lines_colors_[3].r = 1; lines_colors_[3].g = 1; lines_colors_[3].b = 0; lines_colors_[3].a = 1;
    lines_colors_[4].r = 0; lines_colors_[4].g = 1; lines_colors_[4].b = 0; lines_colors_[4].a = 1;
...
void WolfAlgNode::updateLaserParams(const unsigned int laser_idx, const sensor_msgs::LaserScan::ConstPtr& msg)
{
  if (!laser_params_setted_[laser_idx])
  {
    ...
    laserscanutils::ScanParams params = laser_sensor_ptr_[laser_idx]->getScanParams();
    ...
    laser_sensor_ptr_[laser_idx]->setScanParams(params);
